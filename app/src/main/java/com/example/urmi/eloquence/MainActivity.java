        ...
        mSpeechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle results) {
                ...
                if (matches != null) {
                    ...
                    if (foundIndex) {
                        Toast.makeText(MainActivity.this, "You answered '" + saidWord.toUpperCase() + "', which is correct.", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(MainActivity.this, "You answered '" + matches.get(0).toUpperCase() + "', which is incorrect.", Toast.LENGTH_SHORT).show();
                ...
                new android.os.Handler().postDelayed(
                        new Runnable() {
                            public void run() {
                                ...
                                tv.setText("Let's practice our words");
                            }
                        },
                        3000);
            }
